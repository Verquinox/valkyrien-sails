...
public class SailsBlocks {
    ...
    public static void register() {
        ...
        WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        BLACK_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "black_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.BLACK_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        BROWN_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "brown_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.BROWN_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        CYAN_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "cyan_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.CYAN_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        GRAY_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "gray_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.GRAY_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        GREEN_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "green_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.GREEN_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        LIGHT_BLUE_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "light_blue_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.LIGHT_BLUE_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        BLUE_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "blue_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.BLUE_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        LIGHT_GRAY_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "light_gray_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.LIGHT_GRAY_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        LIME_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "lime_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.LIME_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        MAGENTA_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "magenta_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.MAGENTA_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        ORANGE_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "orange_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.ORANGE_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        PINK_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "pink_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.PINK_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        PURPLE_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "purple_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.PURPLE_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        RED_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "red_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.RED_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        WHITE_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "white_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
        YELLOW_WIND_FLAG = BLOCKS.register(ResourceLocation.tryBuild(ValkyrienSails.MOD_ID, "yellow_wind_flag"), () -> new WindFlagBlock(BlockBehaviour.Properties.copy(Blocks.YELLOW_WOOL).noOcclusion().instabreak().explosionResistance(0.0f).ignitedByLava().pushReaction(PushReaction.DESTROY).sound(SoundType.WOOD)));
